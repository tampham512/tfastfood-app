...
import {useRegisterAccountMutation} from 'src/services/RegisterAPI';
...
function Register({navigation}) {
  ...
  const handelSeePassWordConfirm = e => {
    e.stopPropagation();
    setIsCanSeePassWordConfirm(prev => !prev);
  };
            ...
            toast.show({
              ...
              render: () => (
                <Alert
                  color="error"
                  status="error"
                  content="The fields you enter are incorrect. Please check again!"
                />
              ),
            });
          } else {
      ...
      <View style={{backgroundColor: '#FFFFFF'}}>
        ...
        <View style={[styles.container]}>
          <View style={styles.textLogin}>
            <Text style={styles.textconLogin}>Register</Text>
          </View>
